...
namespace ynhnOilManage.Interface.SysManage
{
	...
	/// Left2 的摘要说明。
	/// </summary>
	public class Left2 : System.Web.UI.Page
	{
		#region 页面加载事件处理
...
//			}
			...
			System.Web.UI.HtmlControls.HtmlTable tblCurrent;
			tblCurrent= this.FindControl("tblOilReports") as HtmlTable;
			tblCurrent.Visible = true;
			SetMenuShowByUserPurview(tblCurrent,tblCurrent,Session[ConstValue.LOGIN_USER_PURVIEW_SESSION] as ArrayList);

			tblCurrent= this.FindControl("tblOilTotalReports") as HtmlTable;
			tblCurrent.Visible = true;
			SetMenuShowByUserPurview(tblCurrent,tblCurrent,Session[ConstValue.LOGIN_USER_PURVIEW_SESSION] as ArrayList);

			tblCurrent= this.FindControl("tblOilListReports") as HtmlTable;
			tblCurrent.Visible = true;
			SetMenuShowByUserPurview(tblCurrent,tblCurrent,Session[ConstValue.LOGIN_USER_PURVIEW_SESSION] as ArrayList);


			tblCurrent= this.FindControl("tblMemberReports") as HtmlTable;
			tblCurrent.Visible = true;
			SetMenuShowByUserPurview(tblCurrent,tblCurrent,Session[ConstValue.LOGIN_USER_PURVIEW_SESSION] as ArrayList);

			tblCurrent= this.FindControl("tblSysManage") as HtmlTable;
			tblCurrent.Visible = true;
			SetMenuShowByUserPurview(tblCurrent,tblCurrent,Session[ConstValue.LOGIN_USER_PURVIEW_SESSION] as ArrayList);
