<%@ Page language="c#" Codebehind="wfmMemberCons.aspx.cs" AutoEventWireup="false" Inherits="ynhnOilManage.Interface.Report.wfmMemberCons" %>
	...
	<body bgColor="#0099cc" MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table height="50" width="400" align="center">
				<tr height="30">
					<td align="center" colSpan="2"><font style="FONT-SIZE: 10pt; FONT-WEIGHT: bold">单位充值报表</font>&nbsp;
						<hr>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<asp:Label id="Label5" runat="server">指定加油站：</asp:Label></td>
					<td>
