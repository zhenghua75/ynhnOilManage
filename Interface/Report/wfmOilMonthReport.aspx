	...
	<body bgColor="#0099cc" MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table height="170" width="481" align="center" style="WIDTH: 481px; HEIGHT: 170px">
				<tr height="30">
					<td align="center" colSpan="2"><font style="FONT-SIZE: 10pt; FONT-WEIGHT: bold">油料收、支、存月报表</font>
						<hr>
					</td>
				</tr>
				<tr>
					<td style="WIDTH: 69px; HEIGHT: 24px"><asp:label id="Label1" runat="server">填报单位：</asp:label></td>
					<td style="HEIGHT: 24px"><asp:dropdownlist id="ddlDept" runat="server" Width="218px" Height="22px"></asp:dropdownlist></td>
				</tr>
				<tr>
					<td style="WIDTH: 69px"><asp:label id="Label2" runat="server">填报日期：</asp:label></td>
					<td><FONT face="宋体" style="Z-INDEX: 0"><asp:textbox id="txtBeginDate" onfocus="calendar()" runat="server" Width="216px"></asp:textbox><FONT face="宋体"></FONT></FONT></td>
				</tr>
				<tr>
