...
namespace ynhnOilManage.Interface.Report
{
	...
	/// </summary>
	public class wfmOilStorageLogReport : wfmBase
	{
		#region 字段
		...
		protected System.Web.UI.WebControls.DropDownList ddlOperType;
...
//		}
		private DataTable GetData(string strDeptID,string strBeginDate,string strEndDate,string strOperName,string strOperType)
		{
			...
			string strSql = "select '' as cnnSerialNo,cnvcOperType,cnvcDeptName,cnvcOperName,cndOperDate,cnvcGoodsName,cnvcGoodsType,cnnInOutCount,cnnLastCount,cnnCurCount from tbOilStorageLog where 1=1 ";
			if (strBeginDate != "")
			{
			...
			if (strDeptID != "")
			{
				strSql += " and cnvcDeptID like '"+strDeptID+"%'";
			}
			if (strOperName != "")
			{
				strSql += " and cnvcOperName like '%"+strOperName+"%'";
			}
			strSql += " and cnvcOperType like '"+strOperType+"'";
			...
			dtConsItem.Columns["cnvcOperType"].ColumnName = "操作类型";
			...
			dtConsItem.Columns["cnvcGoodsName"].ColumnName = "物料名称";
			dtConsItem.Columns["cnvcGoodsType"].ColumnName = "物料类型";
			dtConsItem.Columns["cnnInOutCount"].ColumnName = "出入库量";
			dtConsItem.Columns["cnnLastCount"].ColumnName = "上次量";
			dtConsItem.Columns["cnnCurCount"].ColumnName = "当前量";			
			return dtConsItem;
		}
		private void BindGrid(string strDeptID,string strBeginDate,string strEndDate,string strOperName,string strOperType)
		{
			DataTable dtConsItem = GetData(strDeptID,strBeginDate,strEndDate,strOperName,strOperType);
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			BindGrid(this.ddlDept.SelectedValue,this.txtBeginDate.Text,this.txtEndDate.Text,this.txtOperName.Text,this.ddlOperType.SelectedValue);
		}
