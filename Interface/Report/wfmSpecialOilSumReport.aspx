...
<%@ Page language="c#" Codebehind="wfmSpecialOilSumReport.aspx.cs" AutoEventWireup="false" Inherits="ynhnOilManage.Interface.Report.wfmSpecialOilSumReport" %>
	...
	<body bgColor="#0099cc" MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table height="50" width="400" align="center">
				<tr height="30">
					<td align="center" colSpan="2"><font style="FONT-SIZE: 10pt; FONT-WEIGHT: bold">专供油供应汇总表</font>
						<hr>
					</td>
				</tr>
				<tr>
