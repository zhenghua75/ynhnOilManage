	...
	<body bgColor="#0099cc" MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<table height="50" width="400" align="center">
				<tr height="30">
					<td align="center" colSpan="2"><font style="FONT-SIZE: 10pt; FONT-WEIGHT: bold">库存日志明细表</font>
				...
				<tr>
					<td>
						<asp:Label id="Label4" runat="server">操作员：</asp:Label></td>
					<td>
						<asp:TextBox id="txtOperName" runat="server"></asp:TextBox>
						<asp:Label style="Z-INDEX: 0" id="Label5" runat="server">操作类型：</asp:Label>
						<asp:DropDownList style="Z-INDEX: 0" id="ddlOperType" runat="server">
							<asp:ListItem Value="%">所有</asp:ListItem>
							<asp:ListItem Value="验收单修改入库">验收单修改入库</asp:ListItem>
							<asp:ListItem Value="验收单修改出库">验收单修改出库</asp:ListItem>
							<asp:ListItem Value="领料单修改入库">领料单修改入库</asp:ListItem>
							<asp:ListItem Value="领料单修改出库">领料单修改出库</asp:ListItem>
							<asp:ListItem Value="调拨入库">调拨入库</asp:ListItem>
							<asp:ListItem Value="调拨出库">调拨出库</asp:ListItem>
							<asp:ListItem Value="出库单修改出库">出库单修改出库</asp:ListItem>
							<asp:ListItem Value="专供油出库">专供油出库</asp:ListItem>
							<asp:ListItem Value="库存盘点">库存盘点</asp:ListItem>
							<asp:ListItem Value="购入">购入</asp:ListItem>
							<asp:ListItem Value="零售油">零售油</asp:ListItem>
						</asp:DropDownList></td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					...
					<td><FONT face="宋体"><asp:textbox id="txtBeginDate" onfocus="calendar()" runat="server"></asp:textbox>
							<asp:label style="Z-INDEX: 0" id="Label3" runat="server">结束日期：</asp:label>
