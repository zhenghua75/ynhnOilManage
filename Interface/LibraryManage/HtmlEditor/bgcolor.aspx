<%@ Page language="c#" codePage="936" CodeBehind="bgcolor.aspx.cs" AutoEventWireup="false" Inherits="KxdInfo.KM.Interface.QueryInfoManage.HtmlEditor.bgcolor" %>
<html>
<head>
<title>设置背景色</title>
...
<table border="1" cellspacing="10" cellpadding="0" width="260" align="center">
  <tr>
    ...
    <td> <input class=button type=submit onclick='window.returnValue = SelColor.value;window.close();' value="确　定"> 
    </td>
  </tr>
  <tr>
    <td> <input class=button type=button onclick='window.close();' value="取　消"> 
    </td>
  </tr>
</table>
</body>
