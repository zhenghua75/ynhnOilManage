...
namespace ynhnOilManage.EntityObject.EntityClass
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbConsItem")]
	public class ConsItem: EntityObjectBase
	{
		#region 数据表生成变量
		...
		public ConsItem():base()
		{
		}
		
		public ConsItem(DataRow row):base(row)
		{
		}
		
		public ConsItem(DataTable table):base(table)
		{
		}
		
		public ConsItem(string  strXML):base(strXML)
		{
		}
		#endregion
